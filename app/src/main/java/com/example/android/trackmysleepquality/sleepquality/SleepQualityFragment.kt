...
class SleepQualityFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val sleepQualityViewModelFactory=SleepQualityViewModelFactory(arguments.sleepNightKey,dao)
        val viewModel=ViewModelProvider(this,sleepQualityViewModelFactory)
